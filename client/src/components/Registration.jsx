        ...
        <div className='flex h-screen'>
            ...
            <div className='flex flex-col flex-1 items-center justify-center w-full'>
                ...
                <div className='w-2/3 bg-ghost border-1 rounded-md mb-10'>
                    <button className='w-1/2 text-midnightBlu'>Register</button>
                ...
                <button class="px-4 py-2 border flex gap-2 border-midnightBlu rounded-lg text-black hover:bg-midnightBlu hover:text-white mt-2">
